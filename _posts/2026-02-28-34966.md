...
두 개의 구멍이 서로 만날 수 없다면, 모든 물건을 치우는 것은 불가능합니다. 두 개의 구멍이 만날 수 있다면 모든 물건을 치울 수 있으며, 두 개의 구멍은 **최소 두 번 이내**의 시행으로 만날 수 있습니다.
...
처음에 $A$ 에서 출발해 $B$ 의 위치까지 최소 시행을 구하고, $B$ 에서 출발해 $A$ 까지 최소 시행을 구한 뒤 둘 중 더 작은 값을 찾아주면 정답이 될 겁니다.

---
title: "[Platinum I] 마지막 요세푸스 문제 - 1179"
date: 2026-01-24
categories: [PS, BOJ]
tags: [수학, 다이나믹 프로그래밍, 재귀]
...
$$
### 분할 정복
$n$을 줄이는 과정은 **재귀**를 이용하면 좋습니다. 왜냐면 재귀는 결국 큰 문제를 더 작은 문제로 쪼개서 해결할 때 유리하기 때문입니다.
...
$h \ge 0$ 경우는 k명이 죽고 죽은 사람의 자리를 뒤에서 한칸씩 채우게 됩니다. 원래 인덱스를 복원하는 게 목적이기에 $\lfloor \frac{h}{k-1} \rfloor$만큼을 다시 밀어줍니다.

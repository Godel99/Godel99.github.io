---
title: "[Silver II] NOT a SAT problem - 30866"
date: 2026-02-06
...
## **풀이**
### 접근
CNF의 결과를 거짓으로 만들면 됩니다. CNF을 거짓으로 만들려면 하나의 $OR$만 거짓으로 만들면 충분합니다.
...
def main():
    ...
    while m:
        ...
        if flag:
            print('YES')
            for i in range(1, n+1): print(0 if ans[i]==-1 else ans[i], end=' ')
            return 0

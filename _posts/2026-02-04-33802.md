...
절댓값이므로 볼록함수 형태를 띠게 됩니다. 즉, 볼록함수는 V자 모양의 그래프이므로 블록 함수의 최댓값은 처음 시작과 끝에 있다는 점을 알 수 있습니다. 그러므로 $1$ 이상 $M$ 이하 값에서 $1$ 또는 $M$의 값을 실력을 알 수 없는 학생에게 배정해야 실력 차의 절댓값의 누적 합이 최대가 될 수 있습니다.

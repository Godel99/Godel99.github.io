...
즉, 3개의 점을 물어보면 **2개의 점**의 위치를 특정할 수 있게 되어 질문 1번 당 **2개의 점**을 특정하게 됩니다. 그러므로 최대 100개의 점이 있어도 50번의 질문($50 \times 2=100$)을 통해 모든 점의 위치를 특정할 수 있게 되는 것입니다. 그럼 삼각형 내부에 생길 수 있는 점까지 모두 찾아낼 수 있습니다.
